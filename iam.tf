...
resource "aws_iam_policy" "rke_controlplane" {
  name = "rke_controlplane"
  tags = {
    "Name" = "rke_controlplane"
  }
  policy = jsonencode({
...
resource "aws_iam_policy" "rke_etcd_worker" {
  name = "rke_etcd_worker"
  tags = {
    "Name" = "rke_etcd_worker"
  }
  policy = jsonencode({
...
resource "aws_iam_instance_profile" "k8s_master_role" {
  name = "k8s_master_role"
